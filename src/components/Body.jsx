      ...
      // Background Images and Colors
        <div className="divs">
            ...
            <div className="topdiv" 
                style={{backgroundImage: background? 'url("./images/bg-desktop-light.jpg")':'url("./images/bg-desktop-dark.jpg")' }}>
              ...
              <div className="topdivflex">
                ...
                {background? <img src="./images/icon-moon.svg" alt=""/>:<img src="./images/icon-sun.svg" alt=""/> }
                </div>
              </div>
            </div>
                     {/* Bottom background */}
            <div className="bottomdiv" style={{backgroundColor: background?"hsl(233, 11%, 84%)":"hsl(235, 21%, 11%)"}}>
              ...
              <div class="attribution">
                ...
                Coded by <a href="www.twitter.com/aladejanaamajid">Abdul-Majid Aladejana</a>.
              </div>
